...
namespace night_light_profile {
  ...
  namespace {
    ...
    // Circadia's five temperatures normalized between its 1900K night and 6500K day endpoints.
    // Scaling the curve keeps Noctalia's existing user-configured day/night temperatures authoritative.
